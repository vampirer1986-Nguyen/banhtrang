...
export const OrderHistoryView: React.FC<OrderHistoryViewProps> = ({
  ...
  const totalGuests = completedOrders.reduce((sum, o) => sum + (o.customerCount || 0), 0);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto flex-wrap justify-end">
          <button
            ...
            title="Xuất 2 sheet báo cáo sang file Microsoft Excel (.xlsx)"
          ...
          <button
            ...
            disabled={completedOrders.length === 0}
            title="Xuất báo cáo sang file CSV (.csv)"
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-3.5 sm:p-4 border-b border-slate-200 flex items-center justify-between">
          <h3 className="font-bold text-slate-900 text-sm sm:text-base flex items-center gap-2">
            ...
            Danh sách hóa đơn đã thanh toán ({completedOrders.length})
          </h3>
        </div>
          ...
          {completedOrders.length === 0 ? (
            ...
            completedOrders.map((order) => {
              ...
              return (
                <div
                  key={order.id}
                  className="p-3.5 sm:p-4 hover:bg-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-colors"
                >
